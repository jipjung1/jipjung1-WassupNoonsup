...
def make_answer():
    ...
    categories_female = ["Blackpink Jennie","Blackpink Jisoo","Blackpink Lisa","Blackpink Rose","ChungHa","Gfriend EunHa",
            ...
            "ITZY 류진","ITZY 리아","ITZY 신유나","ITZY 황예지","Irene","Jeongyoen","Jessica","Joy","Mina","Momo",
           ...
           "김혜수","김희선","김희애","문근영","문채원","박보영","박신혜","설현","손예진","송지효","송혜교","수지","신민아","에이핑크 김남주","에이핑크 박초롱",
            "에이핑크 손나은","에이핑크 오하영","에이핑크 윤보미","에이핑크 정은지","이나영","이영애","이하늬","임윤아","전지현","최지우","하지원","한가인","한예슬","한지민",
           "한효주","황신혜"]

    categories_male = ['Btob LimHyunSik', 'Btob Pniel', 'Btob SeoEunGwang', 'Chanmin', 'Choisiwon', 
           'Day6 DoWoon', 'Day6 YoungK', 'EXO KAI', 'EXO 디오', 'EXO 레이', 'EXO 백현', 
